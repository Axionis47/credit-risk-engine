      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-100">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <h1 className="text-2xl font-bold mb-2">Idea Hunter</h1>
            <p className="text-muted-foreground mb-6">
              Discover and save great content ideas from Reddit
            </p>
            ...
            <div className="space-y-4">
              <button
                onClick={() => {
                  ...
                  handleGoogleAuth(mockToken)
                }}
                className="w-full bg-white border border-gray-300 rounded-lg px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center justify-center gap-3"
              >
